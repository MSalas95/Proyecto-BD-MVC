...
<div class="container" style="margin-top:40px;">
    <table  id="table"
            ...
            data-url="public/data/reparacion"
            data-toggle="table"
            data-height="0"
            data-page-size = "10"
            data-page-list = "[0]"
...
<!-- Modal para Facturar-->
<!--
<div class="modal fade" id="facturarModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel" align="center">Factura</h4>
            </div>
            <div class="modal-body modal-body-custom">
                <form class="form-horizontal" method="post">
                    <div class="form-group" >
                        <div class="col-sm-4">
                            <input type="text" class="form-control input-md" name="inputNumero" placeholder="Cedula del Cliente" id="inputNumero" readonly>
                            <label for="inputEmail3" class="col-sm-4" id="fecha">fecha</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <label for="inputEmail3" class="col-sm-4"><?php echo $descripcion; ?>descripcion</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Cedula del Cliente</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control input-md" name="inputCedulaCli" placeholder="Cedula del Cliente" id="inputCedulaTec2" readonly>
                        </div>
                    </div>
                    <div class="form-group" >
                        <label for="inputEmail3" class="col-sm-4 control-label">IMEI</label>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control input-md" name="inputImei3" id="inputMonto" readonly>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" align="le">Cancelar</button>
                        <input type="submit" name="enviar3" value="Facturar" class="btn btn-primary">
                    </div>
                </form>
            </div>
        </div>
